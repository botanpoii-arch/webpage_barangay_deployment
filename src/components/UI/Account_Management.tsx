...
export default function AccountManagement() {
  ...
  const processedAccounts = useMemo(() => {
    return accounts.filter((acc) => {
      ...
      if (resProfile) fullName = `${resProfile.first_name || ''} ${resProfile.last_name || ''}`;
      else if (acc.officials) fullName = acc.officials.full_name || '';
      ...
      if (resProfile) {
        ...
        fullName = acc.officials.full_name || 'System Administrator';
      }
                           ...
                           <td>
                              <div className="ACC_PROF_FLEX">
                                 ...
                                 <div className="ACC_PROF_NAME" style={{ fontWeight: 600, color: '#0f172a' }}>
                                    {/* UID removed, only displaying the name */}
                                    {acc.displayName}
                                 </div>
                              </div>
                           </td>
